...
<head>
	<title>Azwar Azuhri</title>
	<meta charset="UTF-8">
	<meta name="Author" content="R0sX_010"/>
	<meta name="copyright" content="R0sX_010"/>
	<meta name="description" content="Website Pawned by R0sX_010"/>
...
<br>
<br>
<font style="color:#ffffff;text-shadow:#FF0099 0px 0px 10px"> &nbsp;&nbsp;&nbsp;&nbsp;<b>[+] Azwar Azuhri       </font> <br>
<font style="color:#ffffff;text-shadow:#FF0099 0px 0px 10px"> &nbsp;&nbsp;&nbsp;&nbsp;<b>[+] Universitas Budi Luhur  </font><br>
<font style="color:#ffffff;text-shadow:#FF0099 0px 0px 10px"> &nbsp;&nbsp;&nbsp;&nbsp;<b>[+] zZZZZzzzzzzzz </font><br>
<font style="color:#ffffff;text-shadow:#FF0099 0px 0px 10px"> &nbsp;&nbsp;&nbsp;&nbsp;<b>[+] <font style="color:red;text-shadow:#000 0px 0px 3px">Azwar</font><font style="color:white;text-shadow:#000 0px 0px 3px"> Azuhri</font>  [+]         </font> <br>
					 <font color="White"> 
...
<center>
<h2 class="glow"><font style="color:green;text-shadow:#000 0px 0px 3px"></font><font style="color:red;text-shadow:#000 0px 0px 3px">Azwar</font><font style="color:white;text-shadow:#000 0px 0px 3px"> Azuhri</font>
...
<!-- <h2 class="glow2" ><font style="color:yellow;text-shadow:#000 0px 0px 3px">.::Pawned By::.</font><br> <span style="color:orange;font-family:Iceland;text-shadow:white 0px 0px 10px">./</span><span style="color:#ffffff;font-family:Iceland;text-shadow:#FF0099 0px 0px 10px">azwarazuhri</span></b></h2> -->
<p><b><font style="color:green;text-shadow:#000 0px 0px 3px">Sorry Admin, I Was On Your System. By </font><span style="font-family:Iceland;color:red;text-shadow:#000 0px 0px 3px">Azwar Azuhri,</span>
			<font style="color:green;text-shadow:#000 0px 0px 3px">PLEASE </font><font style="color:blue;text-shadow:#000 0px 0px 3px">zzzzzzz</font>
		...
		<span style="font-family:Iceland;font-weight:bold;color:#ffffff"><p><font style="color:green;text-shadow:#000 0px 0px 3px">~SECURITY IS JUST AN ILLUSION~</font></p></span>
	</div>
